...
export default function Hero({ darkMode, toggleDarkMode }) {
  ...
  return (
    <section id='home' className={`relative px-6 overflow-hidden min-h-screen flex flex-col transition-colors duration-300 
      ...
      <div className={`hidden md:block h-[500px] w-[500px] lg:h-[680px] lg:w-[680px] right-0 
          ...
          ${darkMode ? 'from-orange-600 via-yellow-500 to-red-400 opacity-20' : 'from-orange-600 via-yellow-900 to-red-300 opacity-15'}`} />

      <Navbar darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
      
      <section data-aos="fade-up" data-aos-delay="250" className="body-font z-10">
        <div className="container mx-auto flex px-8 py-12 md:py-24 flex-col-reverse md:flex-row items-center">
          {/* Left Section */}
            ...
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 mx-auto">
              ...
              <img
                ...
                className={`object-cover object-center rounded-full w-full h-full border-4 
                    ${darkMode ? 'border-orange-500/30 hover:border-orange-500' : 'border-orange-700/30 hover:border-orange-900'} 
